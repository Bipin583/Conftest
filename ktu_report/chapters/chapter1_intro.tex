...
\begin{enumerate}
    ...
    \item To formulate an economic selective prediction policy with conservative full-suite fallback and evaluate its observed escape rate.
    \item To build a research-prototype service stack with FastAPI, Streamlit, and GitHub webhooks.
\end{enumerate}
